...
from experiments.noaa.configs import det_experiments_conf
...
class NOAADeterministicExperiment(MLFlowExperiment):
    ...
    def run(self, **kwargs):
        ...
        if config.n_jobs > 1:
            ...
            preds = [fit_evaluate_interpolator_on_time(time) for time in  tqdm(test_times, desc="fitting krigging at eval times...")]
