...
set2.partial.a.time = dict(start="2021-08-10 01:00", end="2021-08-30 01:00")
...
set2.partial.b.time = dict(start="2013-07-01 01:00", end="2013-07-16 01:00")
...
set2.partial.c.time = dict(start="2011-02-01 01:00", end="2011-02-15 23:00")
...
set3.eval + pd.MultiIndex.from_product([set3.locations_full, eval_sets.time_range]).to_list()

set3.partial.e.locations = ["41046","42058"]
set3.partial.e.time = dict(start="2021-07-10 01:00", end="2021-07-30 23:00")
...
set3.partial.f.locations = ["41043","41047","41025","41010", "41001"]
set3.partial.f.time = dict(start="2019-09-12 01:00", end="2019-10-20 23:00")
