...
# spatial_interpolation documentation build
...
from spatial_interpolation import __version__ as release

# -- Project information -----------------------------------------------------

project = "spatial_interpolation"
author = "QuantumBlack"
...
htmlhelp_basename = "spatial_interpolationdoc"
...
latex_documents = [
    (
        master_doc,
        "spatial_interpolation.tex",
        "spatial_interpolation Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spatial_interpolation",
        "Project spatial_interpolation codebase.",
        "Data-Science",
    )
]
